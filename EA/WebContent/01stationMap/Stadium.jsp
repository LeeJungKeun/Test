...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/EA/FrontControl/addApplyTeam"  method="post">
                <div class="modal-body">

                        <div class="form-group">
                            <label for="stadium_name" class="control-label">경 기 장 :    	</label>
                        ...
                        <div class="form-group">
                            <label for="teamNo" class="control-label">소 속 팀 :</label>
                            <input class="form-control" id="teamNo" name="teamNo">
                        </div>
                        <div class="form-group">
                            <label for="applyPlayer" class="control-label">경 기 인 원 :    </label>
                            <input type="text" class="form-control" id="applyPlayer" name="applyPlayer" >
                        </div>
                        <div class="form-group">
                            <label for="startTime" class="control-label">시 작 시 간 : </label>
                            <input class="form-control" id="startTime" name="startTime">
                        </div>
                        
                        <div class="form-group">
                            <label for="endTime" class="control-label">종 료 시 간 : &nbsp;&nbsp;</label>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="신 청" >
                </div>
            </form>
        </div>
    </div>
